...
using Earth.Data.IO.FileUtils;
using Earth.Data.IO.ImageUtils.CompressUtils.Models;
using Mono.Unix;

namespace Earth.Data.IO.ImageUtils.CompressUtils
{
    internal sealed class Bootstrapper
    {
        ...
        public void RegisterExecutable()
        {
            ...
            // Load tools
            var librariesNameSpace = $"{nameof(Earth)}.{nameof(Data)}.{nameof(IO)}.{nameof(ImageUtils)}.{nameof(CompressUtils)}.Tools";
